...
CATEGORY_DELIVERY = "6"
STAGE_DELIVERY_NEW = "C6:NEW"  # Подготовка товара -> ✅ Тасдиқланди (ёки 🟣, пастга қаранг)

# ── "Тастиклаш анализ" майдони (Bitrix'даги танлов) ────────────────────────
# Айрим буюртмалар тасдиқланмаса ҳам почтага чиқарилади. Шунда сделка
# C6:NEW'га тушади, лекин у ҲАҚИҚАТАН тасдиқланганми ёки "недозвон булиб
# чиқарилган"ми — фақат шу майдондан билинади.
FIELD_CONFIRM_ANALYSIS = "UF_CRM_1777879395123"
CONFIRM_ANALYSIS_OK = "714"          # Тастикланган              -> ✅ Тасдиқланди
CONFIRM_ANALYSIS_NO_ANSWER = "716"   # Недозвон булиб чикарилган -> 🟣 Тасдиқланмай чиқди
